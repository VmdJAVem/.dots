...
function IconProX() {
    this.deviceDescription                  = "iCON QCON Pro X";
    this.midiChannelName                    = "iCON QCON Pro X"; 
    this.midiBackChannelName                = "iCON QCON Pro X"; 
    ...
    this.onMidiReceivedFromDevice = function(d, deviceIndex)
    {
        ...
        else if (d[0] == 0x90)
        {
            ...
            else if (d1 == 0x55)
            {
                ...
                this.lightUpButton (this.mcuIdx, 0x55, d[2] != 0);
            }
            else if (d[2] != 0)
            {
                if (d1 >= 0x08 && d1 <= 0x0f)
    ...
    {
        this.lightUpButton (this.mcuIdx, 0x4f, isLoopOn);
    }

    this.onPunchChanged = function(isPunching)
    {
        this.lightUpButton (this.mcuIdx, 0x4e, isPunching);
    }
    ...
    {
        this.lightUpButton (this.mcuIdx, 0x2a, isSnapOn);
    }

    this.onAutomationReadModeChanged = function(isReading)
    {
        this.lightUpButton (this.mcuIdx, 0x2c, isReading);
    }

    this.onAutomationWriteModeChanged = function(isWriting)
    {
        this.lightUpButton (this.mcuIdx, 0x2d, isWriting);
    }
...
registerController (new IconProX());